...
issp2020_analysed <- issp2020 %>% left_join(rw_voteshare2020, by ="country_name") #for robustness check change to rw_voteshare2020 and same beneath
...
issp2010_analysed <- issp2010 %>%left_join(rw_voteshare2010, by = "country_name")
